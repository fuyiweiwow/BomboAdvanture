...
class StatusBar(UIInstance):
    ...
    def __init__(self):
        ...
        self.prop_imgs = list()
        self.prop_img_mask = pygame.image.load(get_file(StatusBar.ITEM_IMG_PATH + '/' + "img_itemMask.png")).convert_alpha()
    ...
    def init_item_num(self):
        ...
        for i in range(10):
            ...
            img = pygame.image.load(get_file(StatusBar.ITEM_NUM_PATH + '/' + file_name)).convert_alpha()
    ...
    def set_prop_imgs(self, hero):
        ...
        for i in range(len(hero.skill_names)):
            img = pygame.image.load(get_file(StatusBar.ITEM_IMG_PATH + '/' + hero.skill_names[i] + ".png")).convert_alpha()
