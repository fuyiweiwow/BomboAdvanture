...
class BloodBar(UIInstance):
    ...
    def __init__(self, me: Player):
        ...
        self.max_blood = 1
        self.blood_font = pygame.font.Font(get_file("res/font/century.ttf"), 11)
        self.blood_font.set_bold(True)
        self.blood_slice_img = pygame.image.load(get_file(BloodBar.UI_IMG_GAME_ROOT + '/' + "img_playerLife.png")).convert_alpha()
        self.blood_slice_idx = 90  # 0~90 决定血条的长度
        self.blood_slice_last_update_time = pygame.time.get_ticks()
        self.medal_img = pygame.image.load(get_file(BloodBar.UI_IMG_GAME_ROOT + '/' + "medal_30.png")).convert_alpha()
        self.name = ""
        self.name_font = pygame.font.Font(get_file("res/font/simsun.ttc"), 12)
        self.init()
