...
def neighbors(current, npc_grid, limit1, limit2, is_ghost):
    # 计算四个邻位是否可达
    points = []
    x, y = current  # 当前坐标
...
def cal_path(npc_grid, hero_grid, limit1, limit2, is_ghost=False):
    # limit1 区域左上角
    # limit2 区域右下角
    ...
    while not frontier.empty():
        ...
        for next in neighbors(current, npc_grid, limit1, limit2, is_ghost):
